...
# MODEL_PATH = os.path.join(assets_path, "AI_Companion", "Vosk", "Models", "vosk-model-small-en-us-0.15")
MODEL_PATH = os.path.join(script_dir, "Vosk", "Models", "vosk-model-small-en-us-0.15")
...
sock.connect(("localhost", 65434))  # Port must match Unity listener
